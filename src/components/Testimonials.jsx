    ...
    <div className="py-16 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Discover how ImageCraft is helping professionals across India transform their creative workflows and achieve stunning results.
        </p>
      </motion.div>
        ...
        {testimonialsData.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-center mt-6">
              ...
              <p className="text-blue-600 font-medium text-sm mb-2">{item.role}</p>
              ...
              <p className="text-gray-600 text-center italic">"{item.text}"</p>
              
              <div className="mt-6 flex items-center gap-2">
                <span className="px-3 py-1 bg-blue-50 text-blue-600 text-xs rounded-full">Verified User</span>
                {item.role === "UI/UX Designer" && (
                  <span className="px-3 py-1 bg-purple-50 text-purple-600 text-xs rounded-full">Design Pro</span>
                )}
                {item.role === "Full Stack Developer" && (
                  <span className="px-3 py-1 bg-green-50 text-green-600 text-xs rounded-full">Tech Expert</span>
                )}
                {item.role === "Content Creator" && (
                  <span className="px-3 py-1 bg-pink-50 text-pink-600 text-xs rounded-full">Creator</span>
                )}
              </div>
            </div>
          </motion.div>
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
      >
        <p className="text-gray-600 mb-6">Join thousands of satisfied users across India</p>
